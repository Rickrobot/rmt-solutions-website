...
`,
  ...
  'crane-lift-plan-requirements': {
    ...
    content: `
      ...
      <div class="bg-slate-800/50 border border-slate-700/50 rounded-xl p-6 my-8">
        <p class="text-gray-300 mb-0">Need the plan rather than the checklist? Our <a href="/services/mobile-crane-lift-plans">mobile crane lift plan service</a> covers load chart verification, ground bearing pressure and outrigger loading — written and signed off by a CPCS A61 Appointed Person.</p>
  ...
  'lifting-method-statements-rams-guide': {
    ...
    content: `
      ...
      <h2>How RMT Solutions can help</h2>
      <p>RMT Solutions is run by a CPCS A61 Appointed Person with 35 years in UK construction. We write site-specific lifting method statements, risk assessments and <a href="/services/lift-plans">lift plans</a> for excavators, telehandlers, lorry loaders and mobile cranes, and we provide independent <a href="/services/appointed-person">Appointed Person</a> cover — fixed prices from £200, with a quote inside four working hours. If a principal contractor has rejected your RAMS, or you want it right the first time, send us the details and we will turn it around in 24 to 48 hours. See our <a href="/services/method-statements-rams">method statement and RAMS writing service</a> — including rejection recovery, where we diagnose why a returned document failed, rewrite it, and support the resubmission until it is accepted.</p>
    `,
  },
  'lift-plan-cost-uk': {
